...
<!-- InstanceBeginEditable name="head" -->
	<script> navSelected = 5;  subNavSelected = non;
	</script>
...
<br>
		...
		<div class="col-sm-9 padding-20-top padding-0-left content-column mobile-padding-20-left"><!-- InstanceBeginEditable name="EditRegion12" --><?php include 'includes/goal-content.html';?>
