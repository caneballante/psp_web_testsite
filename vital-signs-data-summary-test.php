...
<div class="container-fluid  page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<div class="col-sm-9 padding-20-top padding-0-left content-column mobile-padding-20-left"><!-- InstanceBeginEditable name="EditRegion12" --><h2 class="margin-0-top">Vital Signs Data Summary</h2><div id="show-indicators"></div><script src="js/vital.js"></script><script src="js/datasummary1.js"></script><!-- InstanceEndEditable --></div>
